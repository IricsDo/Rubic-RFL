...
from rubic_rl.policies import MLPTrainingConfig, train_mlp_policy


def main(argv: Sequence[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="Train a NumPy MLP policy on supervised Rubik JSONL data."
    )
    ...
    output["hidden_units"] = args.hidden_units
